function [h, area]=error_ellipse(varargin)
...
elseif r==2 & c==2
  ...
  patch(scale*(x0+k*x),scale*(y0+k*y),[0.9 0.9 0.9]);
  % trapz(scale*(x0+k*x),scale*(y0+k*y))
...
rad2deg(atan(eigvec(2,i(2))./eigvec(1,i(2))))
disp(['Angle of the ellipse: ', num2str(rad2deg(atan(eigvec(2,i(2))./eigvec(1,i(2)))))]);
