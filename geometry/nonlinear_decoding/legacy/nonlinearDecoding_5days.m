...
parfor dayn = 1:length(allBinFR)
    ...
    accuracy(dayn).choiceAcc = binaryDecode(trails, train_y);
...
% save('pfcAcc_npixV.mat', 'accuracy');



%% plot results

% load('pfcAcc_npix.mat')
...
% print('-painters','-depsc',['~/Documents/chandlab/paperFigures/Fig4_s/', 'pfcNlinDecoder_V', '.eps']);
