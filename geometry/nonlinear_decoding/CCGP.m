...
% then we decode RL vs GR (choice in context1) then test onRR vs GL (choice in context2)
% this is the cross condition generalization analysis
...
% save('pmdCCGP_npix_equalTrials.mat', 'accuracy');

%%

% load('pfcCCGP_npix_equalTrials.mat')
...
% print('-painters','-depsc',['~/Documents/chandlab/paperFigures/Fig4/', 'pmdCCGP', '.eps']);
