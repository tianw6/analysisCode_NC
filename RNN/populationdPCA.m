% new2: A6 with 30/30 color cxt
% new3: A6 with 30 color in 1, 30 cxt in 2
% new4: A7: first 3 areas inter-onnected
clear all; clc
...
folder = dir('~/Documents/MATLAB/ChandLab/RNN_data/new4/4AreasA7*.mat');
