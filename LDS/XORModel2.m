classdef XORModel2 < handle
    ...
    %   model = XORModel('rotating_input_imperfect', 150);  % 150° rotation
    %   model.simulate();
    %   model.analyze();
    %   model.visualize();
    ...
    methods
        function obj = XORModel2(model_type, rotation_angle)
            % Constructor
            if nargin < 1
        ...
        function obj = build_network(obj)
            ...
            switch obj.model_type
                ...
                case {'rotating_input', 'rotating_input_imperfect'}
        ...
        function J = select_dynamics(obj, context_sign)
            ...
            switch obj.model_type
                ...
                case {'rotating_input', 'rotating_input_imperfect', 'gain_modulation_input', 'gain_modulation_state'}
                    J = obj.J;
            end
        end
        ...
        function color_sign_rotated = rotate_color_signal(obj, color_sign, context_sign)
            ...
            if context_sign == 1
                ...
                % This is tricky because we need to return what drives both dimensions
                % For now, store both components
        ...
        function input = compute_input(obj, x_t, context_sign, color_sign_rotated, current_time)
            ...
            if current_time >= obj.T_color_onset + 30
                ...
                elseif strcmp(obj.model_type, 'rotating_input_imperfect') && context_sign == -1
                    % Imperfect rotation: add both color and choice components
