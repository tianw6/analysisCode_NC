...
%         colors = lines(numOfStimuli);
        ...
        %%%%%%%%%%%%%%%%%%%% Tian changed this
        %%%%% changge the color to red and green
        colors = [summer(numOfStimuli/2); flipud(autumn(numOfStimuli/2))];
...
% plot time events: vertical line at 0 time point
if ~isempty(events)
...
%     colors = lines(numOfStimuli);
    ...
    %%%%%%%%%%%%%%%%%%%% Tian changed this
    %%%%% change the color to red and green
    colors = [summer(numOfStimuli/2); flipud(autumn(numOfStimuli/2))];
