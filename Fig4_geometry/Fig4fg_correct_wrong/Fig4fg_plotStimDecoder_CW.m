% This code uses results from decodeCtestW3.m and decode_variables_stimulus.m 
% This code generate plots of Fig4f-g: plot each stimulus decoder results on color and choice, plus correct and wrong.
...
% Fig4f: plot color correct vs wrong  
...
title('Fig4f: color correct vs wrong')

% Fig4g: plot choice correct vs wrong  
a = figure('Position', [10 10 900 500]);
...
title('Fig4g: action correct vs wrong')
