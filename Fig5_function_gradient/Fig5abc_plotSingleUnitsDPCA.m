%%%%%%%%%%%%%%%%%%%%
% This code plots Fig 5a-c: scatter plot of functional gradients 

% plot the dpca loadings on color and choice and color x action with coordinates from
% determineCoordiantes.m and loadings from calGradients.m

% after that, we performed linear regression and partial correlation analysis
...
%%%%%%%%%%%%%%%%% 
% plot Fig5a-c or FigS5a-c
% Fig5a-c: each unit's dpc loadings with firing rates normalization 
% FigS5a-c: each unit's dpc loadings without firing rates normalization 
