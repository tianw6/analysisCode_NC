%%%%%%%%%%%%%%%%%%%%
% This code plots Fig 5d: area-averaged spectrolaminar motif
...
%% Fig5g: spectrolaminar profile

% remove 60 and 120 Hz power
...
caxis([0.4 0.9]);
colorbar
title('Fig5d: area 8 spectrolaminar profile')
...
caxis([0.4 0.9]);
colorbar
title('Fig5d: 46D spectrolaminar profile')
...
caxis([0.4 0.9]);
colorbar
title('Fig5d: 46V spectrolaminar profile')
...
caxis([0.4 0.9]);
colorbar
title('Fig5d: 46A spectrolaminar profile')
...
colorbar
ylim([1 230])
title('Fig5d: pmd spectrolaminar profile')
